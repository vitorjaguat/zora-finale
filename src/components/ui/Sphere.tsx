...
export default function Sphere() {
  return (
    ...
    //   }}
    // ></figure>
    <div className="fixed max-sm:top-[calc(100vh-220px)] top-[calc(100vh-550px)] -right-40 z-0 m-0 block h-[600px] w-[600px] mix-blend-difference max-sm:-right-24 max-sm:h-[250px] max-sm:w-[250px]">
