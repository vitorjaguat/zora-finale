...
export default function Menu() {
  return (
    <div className="pointer-events-none sticky top-6 left-0 z-[60] flex h-[100dvh] w-full flex-col justify-between pt-2.5 pl-6 text-neutral-200 mix-blend-difference">
